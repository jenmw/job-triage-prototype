...
const JOBS = [
  // ── 0: Main job — GXO Logistics ─────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About GXO Logistics", text: "GXO Logistics is one of the world's largest pure-play contract logistics companies, operating over 950 warehouses across more than 30 countries. We work with some of the biggest names in retail, e-commerce, food and beverage, and consumer goods to deliver world-class supply chain solutions. At GXO, we believe that logistics is the backbone of modern commerce — and our people are at the heart of everything we do." },
      { label: "About the role", text: "Based at our Corby facility, the Warehouse Operative will play a critical role in ensuring the smooth, accurate and efficient movement of goods through our distribution operation. This is a fast-paced, target-driven environment where attention to detail and a commitment to safe working practices are essential at all times." },
      { label: "What you'll be doing", bullets: [
        "Accurately picking customer orders from warehouse locations using handheld RF scanner technology",
        "Loading and unloading vehicles using counterbalance and electric pump trucks in line with safe operating procedures",
        "Completing put-away tasks and ensuring stock is stored correctly in designated warehouse locations",
        "Conducting regular stock checks and cycle counts to support inventory accuracy",
        "Working at height to retrieve and store palletised goods using appropriate equipment",
        "Identifying quality issues, damaged goods or discrepancies and reporting these through the correct escalation channels",
        "Maintaining a clean, safe and organised working environment at all times",
        "Complying fully with all GXO health, safety and environmental policies and procedures",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse or distribution experience is preferred, though not essential — full training will be provided",
        "Experience operating material handling equipment (MHE) is desirable but not required",
        "GCSE Maths and English grade C or above (or equivalent) preferred",
        "Strong attention to detail with a focus on accuracy",
        "Ability to work effectively as part of a team in a fast-paced environment",
        "Physically fit and able to lift and move items in accordance with manual handling guidelines",
        "Flexible approach to working hours and shift patterns",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive base pay of £25,958/yr with an additional £945/yr shift premium",
        ...
        "Access to the GXO My Benefits platform — includes high street discounts, a cycle-to-work scheme, cashback cards and savings programmes",
        "Uniform and PPE provided",
        "Free on-site parking",
        "Opportunities for progression and development within a global logistics business",
      ]},
    ],
  },
  // ── 1: Amazon Warehouse Associate ───────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Amazon", text: "Amazon is one of the world's most recognised brands, with a global network of fulfilment centres, delivery stations and sortation centres that powers millions of customer orders every day. In the UK alone, Amazon employs tens of thousands of people across its operations network. We are committed to being the most customer-centric company on earth — and our operations teams make that possible." },
      { label: "About the role", text: "As a Warehouse Associate at our Corby Fulfilment Centre, you will work within a large, highly automated warehouse environment, contributing to the process of receiving, storing, picking, packing and dispatching customer orders. No previous warehouse experience is required — Amazon provides comprehensive paid training from your very first day on site." },
      { label: "What you'll be doing", bullets: [
        "Receiving and stowing incoming stock from vendors into appropriate warehouse storage locations",
        "Picking individual customer orders accurately from shelving units, bins and pallet locations",
        "Packing orders securely using appropriate packaging materials and labelling correctly for dispatch",
        "Sorting and transferring parcels between zones and onto outbound conveyors",
        "Meeting hourly and daily productivity targets in line with standard operating procedures",
        "Operating handheld scanning devices and using warehouse management system technology",
        "Reporting safety concerns, near misses and equipment faults through the correct channels",
        "Following all Amazon health, safety and quality procedures at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous warehouse or logistics experience required — Amazon will train you from day one",
        "Ability to stand, walk and remain active for the duration of your shift (typically 10 hours)",
        "Able to safely lift and carry items weighing up to 23kg without assistance",
        "Reliable and punctual — consistent attendance is essential in a fulfilment centre environment",
        "Comfortable working in a target-driven environment with productivity monitoring",
        "Positive attitude and willingness to work as part of a large, diverse team",
        "Flexible to work a range of shifts including nights, weekends and peak periods",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Pay from £13.00/hr, with additional premiums for nights and weekends",
        "Guaranteed contracted hours — no zero-hours contracts",
        "Amazon pension scheme with employer contributions",
        "Employee discount on Amazon.co.uk purchases",
        "Paid breaks and free secure on-site parking",
        "On-site support available 24/7 including occupational health",
        "Clear career pathways with opportunities to progress to process assistant and team leader roles",
        "Access to Amazon's internal learning and development programmes",
      ]},
    ],
  },
  // ── 2: DHL Supply Chain ──────────────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About DHL Supply Chain", text: "DHL Supply Chain is part of Deutsche Post DHL Group, the world's leading logistics company. Operating across more than 50 countries, DHL Supply Chain delivers tailored warehousing and distribution solutions for some of the most well-known brands in retail, consumer, and industrial sectors. We are proud to be an award-winning employer and a Top Employer UK certified business." },
      { label: "About the role", text: "We are seeking reliable and motivated Warehouse Operatives to join our growing team at our Northampton distribution centre. Working on behalf of a key retail client, you will be an integral part of a well-established warehouse operation, ensuring the accurate and timely movement of goods through our facility." },
      { label: "What you'll be doing", bullets: [
        "Picking customer orders accurately from designated warehouse locations using RF scanner technology",
        "Packing and labelling orders in line with client-specific packaging standards and brand requirements",
        "Loading and unloading vehicles using manual handling techniques and warehouse equipment",
        "Completing goods-in procedures including checking, counting and recording inbound deliveries",
        "Carrying out stock replenishment and rotation tasks to maintain availability across all warehouse zones",
        "Performing regular housekeeping tasks to maintain a clean, tidy and safe working environment",
        "Meeting daily KPIs and throughput targets as agreed with line management",
        "Adhering to all DHL health, safety and quality standards at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse, distribution or logistics experience is preferred but not essential",
        "GCSE Maths and English at grade C or above (or equivalent) — desirable",
        "Good attention to detail and a conscientious approach to accuracy",
        "Physically fit and able to stand for extended periods and lift up to 25kg",
        "Ability to work effectively as part of a team in a fast-paced, target-driven environment",
        "Strong commitment to health and safety compliance",
        "Reliable attendance record and punctuality",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive hourly rate of £12.75/hr",
        "Company pension scheme with employer contributions",
        "25 days holiday per year (pro rata), plus bank holidays",
        "Access to the DHL employee discount programme — savings on retail, leisure and lifestyle",
        "Free on-site parking",
        "Uniform and PPE provided at no cost",
        "Career development and internal progression opportunities within DHL's global network",
  ...
  // ── 3: Wincanton ─────────────────────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Wincanton", text: "Wincanton is one of the UK's leading supply chain and logistics businesses, with over 90 years of experience delivering for some of Britain's most recognisable brands. Operating from a network of sites across the country, Wincanton provides contract logistics, transport, storage and fulfilment services across multiple sectors including grocery, general merchandise and defence." },
      { label: "About the role", text: "We currently have an exciting opportunity for enthusiastic and hardworking Warehouse Operatives to join our established team at our Kettering facility. You will support a major retail client account by ensuring goods are received, stored and despatched accurately and on time. This is a full-time role with mixed shift patterns available." },
      { label: "What you'll be doing", bullets: [
        "Picking and packing customer orders accurately against daily pick lists and electronic scan requirements",
        "Receiving and processing inbound deliveries — checking, counting and completing put-away tasks to designated locations",
        "Operating handheld RF scanning equipment to confirm stock movements within the warehouse management system",
        "Undertaking regular stock counting and inventory checks to support accurate stock records",
        "Carrying out replenishment tasks across all warehouse zones",
        "Ensuring the warehouse environment is maintained to a high standard of cleanliness and organisation",
        "Working to daily and weekly throughput targets in line with client KPIs",
        "Complying with all health, safety and environmental requirements at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse, distribution or supply chain experience is preferred",
        "Demonstrable numeracy skills and a high level of attention to detail",
        "GCSE Maths and English grade C or above (or equivalent) would be advantageous",
        "Physically fit and comfortable with manual handling tasks, including lifting up to 25kg",
        "A reliable attendance record and punctual approach to work",
        "Ability to work effectively as part of a team and support colleagues during busy periods",
        "Flexible approach to shift working, including willingness to work across mixed shift patterns",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Hourly rate of £12.00/hr",
        "Company pension scheme",
        "28 days holiday per year including bank holidays",
        "Employee Assistance Programme offering free, confidential support",
        "Free on-site parking",
        "Opportunities for progression within Wincanton's national network",
      ]},
    ],
  },
  // ── 4: XPO Logistics FLT Driver ──────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Hours", text: "Full time, day shifts (Monday–Friday)" },
      { label: "About XPO Logistics", text: "XPO is a global leader in supply chain solutions, operating one of the largest contract logistics networks in the world. With operations across 21 countries and over 800 locations, XPO serves leading companies in industries ranging from retail and e-commerce to aerospace and healthcare. We are driven by technology, talent and a passion for operational excellence." },
      { label: "About the role", text: "We are looking for an experienced and licence-holding FLT Driver to join our warehouse team at our Northampton distribution centre. The successful candidate will be responsible for the safe and efficient movement of palletised goods within our facility, supporting inbound and outbound operations across a busy shift pattern." },
      { label: "What you'll be doing", bullets: [
        "Safely operating counterbalance and reach forklift trucks throughout the warehouse and yard areas",
        "Loading and unloading HGV trailers in the loading bay in line with standard operating procedures",
        "Moving and accurately placing palletised stock into designated racking and floor locations",
        "Completing thorough pre-use checks on all FLT equipment at the start of each shift and reporting defects",
        "Maintaining accurate records of all stock movements using the warehouse management system",
        "Supporting the goods-in team during busy inbound periods including receipt and put-away of deliveries",
        "Working collaboratively with warehouse operatives and shift managers to ensure daily targets are achieved",
        "Adhering strictly to XPO health, safety and site security procedures at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "A valid RTITB or ITSSAR forklift licence — counterbalance is essential; reach truck licence is desirable",
        "Minimum of 1 year of documented, hands-on FLT operating experience in a warehouse or distribution environment",
        "Strong attention to detail, particularly when checking loads and recording stock movements",
        "Good understanding of health and safety requirements associated with FLT operations",
        "Physically fit and able to carry out manual handling tasks in conjunction with FLT duties",
        "Ability to work effectively as part of a team and communicate clearly with colleagues and managers",
        "Flexible and willing to work across a range of shifts including early and late patterns",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive hourly rate of £14.50/hr",
        "Pension scheme with employer contributions",
        "25 days holiday per year, plus bank holidays",
        "Potential for overtime at enhanced rates",
        "Free on-site parking",
  ...
  // ── 5: Amazon Warehouse Team Leader ──────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Amazon", text: "Amazon is one of the world's most customer-centric companies, with a global logistics and fulfilment network that delivers hundreds of millions of packages each year. Our fulfilment centres are the engine of that network — and our people leaders are what make them run. At Amazon, we invest heavily in developing our people, and this role is a direct stepping stone into our broader operations management programme." },
      { label: "About the role", text: "The Warehouse Team Leader (known internally as a Process Guide) is a working supervisory role based on the floor of our Corby Fulfilment Centre. You will be responsible for leading, motivating and developing a team of 15–20 Warehouse Associates across your assigned shift, driving productivity, maintaining quality standards and ensuring all health and safety requirements are met at all times." },
      { label: "What you'll be doing", bullets: [
        "Leading and motivating a team of 15–20 Warehouse Associates through a full operational shift",
        "Monitoring real-time productivity data and taking proactive steps to address any performance gaps",
        "Coaching associates on correct processes, quality standards and safe working procedures",
        "Managing attendance, timekeeping and escalating HR-related concerns to the appropriate teams",
        "Completing accurate end-of-shift reports covering throughput, quality and people metrics",
        "Supporting shift manager with daily briefings, communications and process rollouts",
        "Identifying and sharing best practice across the floor to drive continuous improvement",
        "Acting as a first point of escalation for associate queries, concerns and equipment issues",
      ]},
      { label: "What we're looking for", bullets: [
        "Demonstrable experience in a team leader, supervisor or first-line management role — preferably in a warehouse, logistics or production environment",
        "Strong communication and coaching skills with the ability to motivate and develop a diverse team",
        "Confident working with warehouse management systems and interpreting productivity data",
        "Ability to prioritise effectively and make sound decisions in a fast-paced, target-driven environment",
        "Comfortable being on the warehouse floor and physically active for the full duration of your shift",
        "Flexible to work a range of shift patterns including days, nights and weekends as required",
        "A genuine commitment to safety — you must be a role model for health and safety compliance at all times",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Salary from £34,320 per year (approximately £16.50/hr)",
        "Guaranteed contracted hours with no zero-hours contracts",
        "Amazon pension scheme with employer contributions",
        "Employee discount on Amazon.co.uk",
        "Access to Amazon's internal learning and development programmes",
        "A clear career pathway into Area Manager and Operations Manager roles",
        "Paid breaks and free on-site parking",
      ]},
    ],
  },
  // ── 6: Greencore Production Operative ────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Greencore", text: "Greencore Group is one of the UK's leading manufacturers of convenience food, supplying chilled, ready-to-eat products to major supermarkets and food service operators across the country. With manufacturing sites from Corby to Manton Wood and beyond, we produce millions of meals, sandwiches and salads each week. As a FTSE-listed business, Greencore is committed to sustainable food production and to being a great place to work." },
      { label: "About the role", text: "We are currently recruiting Production Operatives to join our chilled food manufacturing facility in Corby, where we produce high-quality, ready-to-eat meals for major UK supermarket clients. This is a fantastic opportunity for individuals looking to start or develop a career in food production — no prior experience is needed and full training will be provided from your first day." },
      { label: "What you'll be doing", bullets: [
        "Working as part of a production line team to manufacture chilled food products to the highest quality and food safety standards",
        "Operating food processing equipment in accordance with documented standard operating procedures",
        "Conducting regular visual quality checks and ensuring all products meet specification before leaving your line",
        "Following all food hygiene, allergen management and health and safety procedures at all times",
        "Assisting with line cleaning activities, changeover tasks and end-of-shift deep cleans as required",
        "Completing and maintaining accurate production and quality records throughout the shift",
        "Supporting colleagues during periods of high demand and contributing to a positive team environment",
        "Reporting any machinery faults, quality concerns or near-miss incidents promptly to your line manager",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous food production or manufacturing experience required — Greencore will provide full paid training",
        "A Level 2 Food Hygiene certificate is preferred, though Greencore can support you in obtaining this qualification",
        "Ability to work in a chilled environment (temperatures typically between 2°C and 8°C)",
        "Physically fit and able to stand for extended periods throughout your shift",
        "GCSE Maths and English at grade C or above (or equivalent) is desirable",
        "A reliable and punctual approach to work — consistent attendance is essential in a manufacturing environment",
        "A positive, can-do attitude and willingness to learn new skills",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive hourly rate of £13.25/hr (approximately £27,560/yr)",
        "33 days holiday per year including bank holidays",
        "Company pension scheme with employer contributions",
        "Free hot meals provided on site during your shift",
        "Colleague discount scheme",
        "Uniform and PPE provided",
        "Structured development programme with opportunities to progress to line leader and beyond",
  ...
  // ── 7: Royal Mail Parcel Sorter ───────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Royal Mail", text: "Royal Mail is the UK's designated universal postal service provider, with a history stretching back over 500 years. Today, Royal Mail delivers to 32 million addresses across the United Kingdom, six days a week, employing over 140,000 people in the process. As one of the nation's most iconic and trusted brands, Royal Mail plays a central role in connecting communities and keeping the country moving." },
      { label: "About the role", text: "We are looking for reliable and physically active Parcel Sorters to join our Wellingborough Delivery Office. Working as part of a close-knit team, you will play a vital role in preparing mail and parcels for delivery rounds across local routes. This is a fast-paced, early-start role that requires high levels of accuracy, consistency and physical effort throughout the shift." },
      { label: "What you'll be doing", bullets: [
        "Sorting incoming letters, parcels and packets by delivery route using both manual and automated processes",
        "Preparing mail for daily delivery rounds, including sequencing and organising by postcode and round number",
        "Operating barcode scanning equipment to track and confirm movement of items through the facility",
        "Loading and unloading delivery vehicles including vans and cages in the loading bay",
        "Assisting with the safe and efficient unloading of incoming mail bags and pallet deliveries",
        "Keeping the sorting area clean, organised and free from hazards throughout the shift",
        "Meeting daily throughput targets and productivity standards as set by your supervisor",
        "Reporting any damaged items, security concerns or operational issues through the correct channels",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous experience required — Royal Mail provides a full induction and on-the-job training programme",
        "Must be able to safely lift and carry items weighing up to 20kg on a frequent basis",
        "Reliable and punctual — early starts (typically from 05:00) are a non-negotiable requirement of this role",
        "Ability to work at pace and maintain accuracy throughout a physically demanding shift",
        "Comfortable working in a busy, noisy environment with large volumes of mail during peak periods",
        "A team-focused approach and willingness to support colleagues during high-volume periods",
        "GCSE Maths and English at grade C or above (or equivalent) desirable but not essential",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive hourly rate of £13.15/hr (approximately £27,352/yr)",
        "Royal Mail pension scheme with employer contributions",
        "25 days holiday per year plus bank holidays",
        "Sick pay scheme (eligibility criteria apply — speak to your recruiter for details)",
        "Employee discount portal with savings on retail, travel and leisure",
        "Uniform and safety footwear provided",
        "Free on-site parking",
      ]},
    ],
  },
  // ── 8: Evri Parcel Hub Operative ─────────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Evri", text: "Evri (formerly Hermes) is one of the UK's biggest parcel delivery companies, delivering over 700 million parcels each year on behalf of thousands of retailers and businesses. Our national hub network is the backbone of our operation, connecting collection points to delivery couriers across the country. We are growing rapidly and looking for motivated people to help us keep the UK's parcels moving." },
      { label: "About the role", text: "Based at our Corby parcel hub, Hub Operatives are essential to the smooth running of our network. You will work as part of a team to sort, scan and load parcels onto outbound trailers, ensuring everything moves through the hub accurately and on time. Shifts are available across days, nights and weekends — full and part-time hours are offered." },
      { label: "What you'll be doing", bullets: [
        "Manually sorting inbound and outbound parcels by destination zone using moving belt conveyor systems",
        "Scanning parcels using handheld devices to confirm receipt, movement and loading",
        "Loading and unloading trailers in the hub yard, ensuring parcels are secured correctly for transit",
        "Identifying and reporting damaged, undeliverable or incorrectly labelled parcels",
        "Meeting hourly throughput targets and maintaining productivity levels throughout the shift",
        "Supporting team leads with housekeeping tasks and general hub cleanliness",
        "Following all Evri health, safety and operational procedures at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous experience required — full training is provided",
        "Able to lift and move parcels weighing up to 31.5kg on a regular basis throughout the shift",
        "Comfortable standing and remaining physically active for the full duration of your shift",
        "Flexible approach to shift times — availability across days, nights and weekends is advantageous",
        "A reliable and punctual approach to work",
        "Ability to work at pace within a team environment",
        "Right to work in the UK",
      ]},
      { label: "Please note", text: "Contract types at this site vary and include full-time, part-time and zero-hours arrangements. Please ensure you confirm the contract type being offered before accepting any role." },
      { label: "What we offer", bullets: [
        "Pay from £11.85/hr",
        "Flexible shift patterns to suit your lifestyle",
        "Weekly pay",
        "Staff discount on Evri parcel deliveries",
        "Free on-site parking",
      ]},
    ],
  },
  // ── 9: Clipper Logistics Pick & Pack ──────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Location", text: "Corby, Northamptonshire, NN17" },
      { label: "Hours", text: "Full time, day shifts (Monday–Friday)" },
      { label: "About Clipper Logistics", text: "Clipper Logistics is a leading provider of value-added logistics services to some of the UK's most prestigious fashion, retail and e-commerce brands. As part of GXO Logistics, we operate fulfilment centres across the UK, handling everything from receiving and quality checking to pick, pack and returns processing. If you care about brands and standards, you'll feel at home at Clipper." },
      { label: "About the role", text: "We are recruiting Pick & Pack Operatives to join our busy fulfilment operation at our Corby site. Working on behalf of a high-profile retail brand client, you will be responsible for picking individual online customer orders with accuracy and care, packing them to the brand's exacting standards, and ensuring they are ready for dispatch on time." },
      { label: "What you'll be doing", bullets: [
        "Accurately picking individual customer orders from warehouse locations using handheld RF scanner technology",
        "Packing items carefully to client brand standards, using the correct packaging materials and inserts",
        "Applying correct shipping labels and checking all order documentation before items move to dispatch",
        "Meeting and sustaining hourly pick rate targets as set by your shift manager",
        "Replenishing stock in pick faces as required throughout the shift",
        "Processing returns and exchanges accurately in line with client-specific procedures",
        "Maintaining a clean, organised and safe work area at all times",
        "Reporting any damaged stock, pick errors or equipment issues promptly",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous warehouse experience required — full training is provided",
        "Comfortable with repetitive tasks and able to maintain high accuracy throughout the shift",
        "Good attention to detail — picking and packing errors directly affect the customer experience",
        "Physically fit and able to stand and walk for the duration of your shift",
        "A reliable and punctual approach to work — attendance consistency is essential",
        "Comfortable working in a target-driven environment with hourly performance monitoring",
        "GCSE Maths and English at grade C or above (or equivalent) is desirable",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Competitive hourly rate of £12.10/hr",
        "Company pension scheme with employer contributions",
        "28 days holiday per year including bank holidays",
        "Staff discount at participating client retail brands",
        "Opportunities for overtime at enhanced rates",
        "Uniform provided",
        "Free on-site parking",
      ]},
    ],
  ...
  // ── 10: PepsiCo — Warehouse Operative ────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About PepsiCo", text: "PepsiCo is one of the world's leading food and beverage companies, with a portfolio of brands including Walkers, Pepsi, Quaker, Tropicana and Doritos. With operations in over 200 countries and territories and annual revenues exceeding $80 billion, PepsiCo is a global powerhouse. In the UK, we manufacture and distribute some of the nation's best-loved snacks and drinks from sites across the country." },
      { label: "About the role", text: "We are looking for Warehouse Operatives to join our busy distribution operation in Leicester, supporting the storage and dispatch of products from across the PepsiCo portfolio. You'll be working in a large, fast-paced warehouse environment, contributing to the daily movement of thousands of cases of product to customers across the UK." },
      { label: "What you'll be doing", bullets: [
        "Picking pallet and case orders accurately using voice pick or RF scanning technology",
        "Packing and wrapping outbound pallets to the required standard for safe transport",
        "Loading and unloading delivery vehicles in line with safe operating procedures",
        "Receiving inbound stock and completing put-away tasks to designated warehouse locations",
        "Conducting stock checks and supporting periodic inventory counts",
        "Operating electric pallet trucks and other warehouse equipment safely",
        "Adhering to all PepsiCo health, safety, food safety and hygiene standards",
        "Meeting daily pick rate, accuracy and throughput targets",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse or distribution experience is preferred",
        "Physically fit and able to handle cases of product and operate manual handling equipment",
        "GCSE Maths and English at grade C or above (or equivalent)",
        "Reliable, punctual and committed to strong attendance",
        "Comfortable working in a fast-paced, target-driven environment",
        "Willingness to work rotating shifts including early mornings, late evenings and weekends",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Salary of £34,727/yr on a rotating shift pattern",
        "PepsiCo pension scheme with generous employer contributions",
        "Annual bonus scheme (subject to performance)",
        "Staff product discount — access to PepsiCo brands at reduced prices",
        "Private medical insurance (eligibility criteria apply)",
        "Life assurance",
        "Free on-site parking",
  ...
  // ── 11: The Best Connection — Warehouse Operative ────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About The Best Connection", text: "The Best Connection is one of the UK's leading recruitment agencies, specialising in the provision of temporary and contract workers across the industrial, logistics, driving and manufacturing sectors. With branches nationwide, The Best Connection works with a diverse range of client businesses to supply reliable, work-ready candidates at short notice. We pride ourselves on finding the right people for the right roles, quickly." },
      { label: "About the role", text: "The Best Connection is currently seeking Warehouse Operatives for immediate placement at multiple client sites in and around Corby. Duties will vary depending on the site you're placed at, but generally include goods-in, picking, packing, despatch and general warehouse support. Candidates must be available to work full-time day shifts and start as soon as possible." },
      { label: "What you'll be doing", bullets: [
        "Picking and packing customer orders in line with client-specific procedures and accuracy requirements",
        "Receiving and processing inbound deliveries including checking, counting and put-away",
        "Loading and unloading delivery vehicles using manual handling techniques",
        "Operating handheld scanners and completing basic warehouse documentation",
        "Carrying out stock replenishment tasks and supporting inventory activities",
        "Maintaining a clean and safe work environment in line with site health and safety rules",
        "Completing any other warehouse duties as reasonably requested by the client supervisor",
      ]},
      { label: "What we're looking for", bullets: [
        "No specific warehouse experience is required — a positive attitude and willingness to work hard is what matters",
        "Physically fit and able to lift and carry items throughout your shift",
        "Reliable and punctual — client sites require consistent attendance",
        "Flexible and adaptable — you may be placed at different sites depending on availability",
        "Comfortable working in a fast-paced environment and following instructions",
        "GCSE Maths and English grade C or above (or equivalent) desirable",
        "Right to work in the UK — you will need to provide two forms of ID",
      ]},
      { label: "What we offer", bullets: [
        "Competitive pay rate of £13.28/hr",
        "Weekly pay",
        "Holiday pay accrued on all hours worked",
        "Access to the Best Connection benefits portal",
        "Ongoing work — not just a one-off placement",
        "Opportunity to secure a permanent role at client sites for the right candidates",
      ]},
    ],
  },
  // ── 12: Group Nexus — Warehouse Operative (Northampton) ───────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Group Nexus", text: "Group Nexus is a specialist recruitment and workforce solutions provider, working with clients across the logistics, warehousing, manufacturing and driving sectors. With an extensive network of client sites across the Midlands and beyond, Group Nexus connects job seekers with temporary and permanent opportunities that suit their skills and availability. We work hard to keep our candidates in consistent, well-matched placements." },
      { label: "About the role", text: "Group Nexus is currently recruiting Warehouse Operatives for client sites in and around Northampton. A range of shift patterns are available including days, lates and nights, making this an ideal opportunity for candidates with different scheduling needs. Pay rates vary depending on the shift worked — please see below for full details." },
      { label: "What you'll be doing", bullets: [
        "Carrying out goods-in activities including unloading vehicles, checking and booking in deliveries",
        "Picking orders from warehouse locations using paper, scanner or voice pick technology (dependent on site)",
        "Packing and labelling outbound orders to client-specific standards",
        "Loading vehicles and preparing outbound consignments for despatch",
        "Conducting stock checks and supporting inventory accuracy tasks",
        "Maintaining a safe and tidy work environment at all times",
        "Completing any additional warehouse duties as directed by the site supervisor",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous experience is required — full induction training will be provided at the client site",
        "Physically fit and able to perform manual handling tasks throughout your shift",
        "Flexible and available to work rotating shifts including days, lates and nights",
        "Reliable, punctual and committed to maintaining good attendance",
        "Able to follow instructions clearly and work well within a team",
        "Right to work in the UK — you will be required to provide evidence at registration",
      ]},
      { label: "What we offer", bullets: [
        "Pay from £12.21/hr (days) up to £19.32/hr (nights) depending on shift",
        "Weekly pay",
        "Holiday pay accrued on all hours worked",
        "Variety of shifts to suit different lifestyles",
        "Opportunity for temp-to-perm for the right candidates",
      ]},
    ],
  },
  // ── 13: Group Nexus — Warehouse Operative (Wellingborough) ───────────────────
  {
    ...
    jd: [
      ...
      { label: "Hours", text: "Full time, rotating shifts including days, lates and nights" },
      { label: "About Group Nexus", text: "Group Nexus is a specialist recruitment and workforce solutions provider, placing candidates across logistics, warehousing, manufacturing and driving roles throughout the Midlands and East of England. We have strong, long-standing relationships with established client sites in and around Wellingborough, and work hard to place candidates in roles that offer consistent hours and a stable working environment." },
      { label: "About the role", text: "Group Nexus is actively recruiting Warehouse Operatives for ongoing placements at client sites around Wellingborough. Shifts are available across days, lates and nights, with pay rates varying significantly depending on the shift worked. This is a suitable role for candidates who are flexible and looking for steady, full-time warehouse work in the local area." },
      { label: "What you'll be doing", bullets: [
        "Carrying out goods-in activities including vehicle unloading, delivery checking and booking-in procedures",
        "Order picking using paper, scanner or voice pick systems as required by the client site",
        "Packing and preparing outbound orders for despatch to client-specific standards",
        "Loading vehicles and managing outbound consignment documentation",
        "Supporting stock accuracy through cycle counts and inventory checks",
        "Maintaining a clean, safe and well-organised work area throughout each shift",
        "Undertaking any other reasonable warehouse duties as directed by the site supervisor",
      ]},
      { label: "What we're looking for", bullets: [
        "No previous warehouse experience necessary — training will be given at the client site",
        "Physically fit and comfortable with manual handling and lifting throughout your shift",
        "Available and willing to work rotating shift patterns including nights",
        "Reliable, consistent attendance — our clients depend on us to deliver a dependable workforce",
        "A flexible and positive attitude to work",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Pay from £12.24/hr (days) up to £21.33/hr (nights) depending on shift",
        "Weekly pay",
        "Holiday pay accrued on all hours worked",
        "Range of shift patterns available to suit your availability",
        "Temp-to-perm opportunities at selected client sites",
      ]},
    ],
  },
  // ── 14: Yusen Logistics — Warehouse Operative ─────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Hours", text: "Full time, day shifts" },
      { label: "About Yusen Logistics", text: "Yusen Logistics is a global supply chain management company, part of the NYK Group — one of Japan's leading international shipping and logistics businesses. Operating in over 40 countries worldwide, Yusen provides freight forwarding, contract logistics and supply chain solutions to multinational and domestic clients across a wide range of industries. In the UK, we operate a growing network of distribution and fulfilment facilities." },
      { label: "About the role", text: "We currently have an opening for a Warehouse Operative to join our team at our Courteenhall, NN7 site. Working as part of a well-organised and stable team, you will be responsible for the accurate receipt, storage and despatch of goods, supporting a key client account with reliable, high-quality warehouse operations on a day shift basis." },
      { label: "What you'll be doing", bullets: [
        "Receiving and processing inbound stock deliveries, including checking quantities, condition and documentation",
        "Accurately putting away stock into designated warehouse locations in line with the warehouse management system",
        "Picking customer orders using RF scanners against pick lists, ensuring accuracy at all times",
        "Preparing goods for despatch including packing, wrapping and labelling to required standards",
        "Conducting regular stock checks and supporting periodic inventory counts",
        "Operating manual handling equipment including pallet trucks and pump trucks safely",
        "Maintaining a clean, safe and organised warehouse environment",
        "Reporting any stock discrepancies, damages or health and safety concerns to the supervisor",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse or logistics experience is preferred",
        "Good attention to detail and a conscientious approach to accuracy in all tasks",
        "Physically fit and comfortable carrying out manual handling tasks throughout the shift",
        "GCSE Maths and English at grade C or above (or equivalent) is desirable",
        "A reliable and punctual approach to work with a consistent attendance record",
        "Ability to work effectively as part of a close-knit team",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Salary of £27,081 per year (approximately £13.02/hr)",
        "Company pension scheme",
        "Holiday entitlement in line with statutory requirements",
        "Free on-site parking",
        "A stable, consistent day shift pattern",
        "Opportunity to develop your skills within a global logistics business",
      ]},
    ],
  },
  // ── 15: Rhenus Group — Warehouse Supervisor ───────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Location", text: "Corby, NN17" },
      { label: "Hours", text: "Full time, rotating shifts" },
      { label: "About Rhenus Group", text: "Rhenus Group is an international logistics service provider with over 37,000 employees at more than 1,000 business locations across the globe. Offering a comprehensive portfolio of logistics services including freight logistics, warehousing, port operations and more, Rhenus is a trusted partner to businesses of all sizes. In the UK, we operate a growing network of contract logistics sites serving diverse industry sectors." },
      { label: "About the role", text: "We are seeking an experienced and driven Warehouse Supervisor to join our team at our Corby facility. In this working supervisory role, you will take responsibility for leading a team of warehouse operatives across your assigned shift, ensuring that daily throughput targets are achieved, quality standards are maintained, and all health and safety requirements are fully complied with." },
      { label: "What you'll be doing", bullets: [
        "Providing direct supervision to a team of warehouse operatives, allocating tasks and managing workload across the shift",
        "Monitoring team performance against daily throughput, accuracy and quality KPIs and taking corrective action where required",
        "Conducting shift briefings and communicating relevant operational updates, process changes and safety information",
        "Overseeing inbound and outbound operations including receipt, storage, picking, packing and despatch",
        "Ensuring all health, safety and security procedures are observed by all team members at all times",
        "Managing attendance, identifying absence patterns and escalating HR-related concerns to the operations manager",
        "Supporting recruitment and induction of new team members, including on-the-job training and sign-off",
        "Completing end-of-shift reporting and contributing to continuous improvement initiatives across the site",
      ]},
      { label: "What we're looking for", bullets: [
        "Demonstrable previous experience in a warehouse supervisory or team leader role is essential",
        "Strong leadership and interpersonal skills with the ability to motivate and manage a team in a pressured environment",
        "Good IT skills including confidence with Microsoft Office and warehouse management systems",
        "Solid understanding of health and safety legislation as it applies to warehouse operations",
        "Excellent communication skills — both written and verbal",
        "A proactive, solutions-focused approach to problem solving",
        "Flexible to work rotating shift patterns including early, late and weekend shifts",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Salary of £28,500 per year",
        "Company pension scheme with employer contributions",
        "28 days holiday including bank holidays",
        "Free on-site parking",
        "Uniform and PPE provided",
        "Opportunities for progression into operations management within Rhenus Group's UK and European network",
      ]},
    ],
  },
  // ── 16: Rhenus Group — Warehouse Manager ─────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "About Rhenus Group", text: "Rhenus Group is an international logistics service provider headquartered in Holzwickede, Germany, with a turnover exceeding €7 billion and operations spanning more than 1,000 locations worldwide. In the UK, Rhenus operates a growing contract logistics division, partnering with clients across retail, industrial and consumer sectors to deliver high-quality warehousing and distribution services. We are committed to sustainable logistics and to developing our people." },
      { label: "About the role", text: "Rhenus Group is seeking an experienced and commercially minded Warehouse Manager to take overall operational responsibility for our Corby facility. This is a senior site management role requiring proven leadership capability, strong analytical skills, and a track record of delivering performance in a fast-paced contract logistics environment." },
      { label: "What you'll be doing", bullets: [
        "Taking full operational accountability for day-to-day warehouse performance across all shifts and functions",
        "Managing a team of supervisors and warehouse operatives, providing leadership, development and performance management",
        "Driving performance against contractual KPIs covering throughput, accuracy, health and safety and cost",
        "Developing and implementing operational improvement plans in partnership with the client account team",
        "Overseeing budget management, cost control and labour resource planning for the site",
        "Ensuring full compliance with health, safety, environmental and legal requirements at all times",
        "Acting as the primary operational point of contact for the client relationship on site",
        "Producing regular performance reports, MI and operational updates for senior stakeholders",
        "Leading the recruitment, onboarding and development of the site team in collaboration with HR",
      ]},
      { label: "What we're looking for", bullets: [
        "Proven experience in a warehouse or distribution centre management role — experience in contract logistics is preferred",
        "Strong leadership skills with demonstrated ability to manage, develop and inspire large operational teams",
        "Experience with warehouse management systems (WMS) — hands-on proficiency is essential",
        "Commercially aware, with experience managing budgets and driving cost efficiency",
        "A thorough understanding of health and safety obligations in a warehousing environment",
      ...
      { label: "What we offer", bullets: [
        ...
        "Free on-site parking",
        "Car allowance or company car (subject to role requirements)",
        "Genuine opportunities for progression within a growing international logistics business",
      ]},
    ],
  },
  // ── 17: Reed — Warehouse Operative ───────────────────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Location", text: "Northampton" },
      { label: "Hours", text: "Full time, day shifts" },
      { label: "About Reed", text: "Reed is the UK's largest family-owned recruitment agency, with over 3,000 specialist recruiters working across more than 100 offices nationwide. With a heritage stretching back to 1960, Reed has placed millions of people into work across every sector imaginable. Reed's industrial and logistics division is one of the busiest in the UK, sourcing temporary and permanent warehouse workers for major clients across the supply chain." },
      { label: "About the role", text: "Reed is currently seeking Warehouse Operatives for ongoing temporary placements with well-established client sites in and around Northampton. Successful candidates can expect consistent full-time hours on day shifts, with the potential for overtime and permanent placement for those who demonstrate strong performance and reliability." },
      { label: "What you'll be doing", bullets: [
        "Picking customer orders from warehouse locations using paper-based or RF scanner systems",
        "Packing and labelling outbound orders to the relevant client standard",
        "Processing goods-in and completing inbound receipt documentation",
        "Loading and unloading delivery vehicles manually or using warehouse equipment",
        "Supporting inventory accuracy through stock checks and cycle count activities",
        "Ensuring your work area is kept clean, safe and organised at all times",
        "Completing any additional duties as requested by the site supervisor or client manager",
      ]},
      { label: "What we're looking for", bullets: [
        "No specific previous experience is required — a willingness to work hard is what matters",
        "Physically fit and able to carry out manual handling activities throughout your shift",
        "Reliable and punctual — our clients rely on us to supply dependable workers",
        "A flexible approach — you may be asked to work at different sites within the Northampton area",
        "Good communication skills and ability to follow instructions clearly",
        "Right to work in the UK — two forms of ID will be required at registration",
      ]},
      { label: "What we offer", bullets: [
        "Pay rate of £13.50/hr",
        "Weekly pay",
        "Holiday pay accrued throughout your assignment",
        "Access to the Reed Benefits Hub — online discounts and wellbeing resources",
        "Temp-to-perm opportunities for high-performing candidates",
        "Free registration and support throughout your placement from your dedicated Reed consultant",
      ]},
    ],
  },
  // ── 18: Millbrook Healthcare — Warehouse Operative ────────────────────────────
  {
    ...
    jd: [
      ...
      { label: "Hours", text: "Full time, day shifts" },
      { label: "About Millbrook Healthcare", text: "Millbrook Healthcare is one of the UK's leading providers of community equipment services and complex rehabilitation solutions, working in partnership with NHS Integrated Care Boards, local authorities and clinical commissioning groups to supply and maintain essential medical equipment for patients in the community. Operating from depots across England, we are committed to improving patient outcomes and making a meaningful difference to people's lives every day." },
      { label: "About the role", text: "We are recruiting a Warehouse Operative to join our friendly and dedicated team at our Northampton depot. This is a fulfilling role for someone who wants their work to have a real purpose — the equipment you pick, pack and prepare goes directly to patients and NHS healthcare facilities across the region. Previous healthcare experience is not required, but a caring and conscientious approach is essential." },
      { label: "What you'll be doing", bullets: [
        "Picking and packing medical equipment orders accurately against pick lists and electronic requests",
        "Preparing equipment for delivery to patients in the community and to NHS healthcare facilities",
        "Receiving and booking in returned equipment, completing condition checks and cleaning as required",
        "Loading and unloading delivery vehicles and ensuring equipment is secured safely for transport",
        "Maintaining accurate stock records within the depot management system",
        "Carrying out regular cleaning and decontamination of returned equipment in line with infection control procedures",
        "Supporting stock checks and inventory audits",
        "Ensuring the depot is maintained to a high standard of cleanliness and organisation at all times",
      ]},
      { label: "What we're looking for", bullets: [
        "Previous warehouse or stores experience is desirable, though not essential",
        "A genuinely caring and empathetic attitude — our work directly affects vulnerable patients",
        "Physically fit and comfortable with manual handling including larger items of medical equipment",
        "Good attention to detail — accuracy in picking and packing directly impacts patient care",
        "Comfortable working in a healthcare-adjacent environment involving the handling of medical items",
        "A reliable, punctual and consistent approach to attendance",
        "GCSE Maths and English at grade C or above (or equivalent) preferred",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        "Salary of £25,400 per year (approximately £12.21/hr)",
        "Company pension scheme",
        "28 days holiday per year including bank holidays",
        "Free on-site parking",
        "Uniform provided",
        "The opportunity to make a genuine difference to patients' lives every day",
        "A supportive team environment in a stable, NHS-partnered organisation",
      ]},
    ],
  },
  // ── 19: Samworth Brothers — Warehouse Operations Manager ─────────────────────
  {
    ...
    jd: [
      ...
      { label: "Location", text: "Leicester" },
      { label: "Hours", text: "Full time, days" },
      { label: "About Samworth Brothers", text: "Samworth Brothers is a family-owned British food company with a proud heritage stretching back to 1896. Headquartered in Leicester, we employ around 10,000 people across our portfolio of brands and manufacturing sites, producing premium chilled food products for major UK retailers. Our brands include Ginsters, Soreen, West Cornwall Pasty Co. and Bradgate Bakery — names that millions of people enjoy every day." },
      { label: "About the role", text: "We are seeking an experienced and highly capable Warehouse Operations Manager to take strategic and operational responsibility for our warehousing function at our Leicester facility. Reporting to the site's Head of Operations, you will lead a multi-shift warehouse team and be accountable for performance across intake, storage, order fulfilment and despatch, ensuring we meet the exacting quality and service standards expected by our retail customers." },
      { label: "What you'll be doing", bullets: [
        "Providing strategic and operational leadership across all warehouse functions including intake, storage, picking and despatch",
        "Managing a team of shift supervisors and warehouse operatives, driving performance, engagement and development",
        "Owning warehouse KPIs covering throughput, accuracy, waste, cost and health and safety compliance",
        "Developing and implementing continuous improvement initiatives to drive operational efficiency and service quality",
        "Managing the WMS and ensuring all data integrity requirements are maintained across inventory and stock records",
        "Leading the recruitment, onboarding and performance management of the warehouse team in partnership with HR",
        "Building and maintaining strong relationships with internal stakeholders including production, logistics and planning",
        "Ensuring full compliance with food safety (BRC/BRCGS), health and safety and environmental legislation",
        "Contributing to the site's operational strategy and presenting performance data to senior leadership",
      ]},
      { label: "What we're looking for", bullets: [
        "Proven experience in a senior warehouse management role, ideally within food, FMCG or chilled logistics",
        "Strong leadership and people management capability — this is a large, multi-shift operation",
        "Hands-on experience with warehouse management systems (WMS) — including data analysis and reporting",
        "A sound understanding of food safety standards including BRC/BRCGS and HACCP principles",
        "Commercially minded with experience managing operational budgets and labour resource plans",
        "Excellent communication and influencing skills across all levels of a business",
        "A proactive, continuous improvement mindset with experience leading lean or efficiency projects",
        "Right to work in the UK",
      ]},
      { label: "What we offer", bullets: [
        ...
        "Company pension scheme with employer contributions",
        "25 days holiday plus bank holidays",
        "Staff discount on Samworth Brothers products",
        "Employee Assistance Programme",
        "Free on-site parking",
        "A high-profile, autonomous management role within one of the UK's most respected food businesses",
      ]},
    ],
  },
  ...
  return (
    <>
      ...
      <div ref={scrollRef} style={{ position: "fixed", bottom: 0, left: 0, right: 0, maxHeight: "85vh", background: COLORS.bg, borderRadius: "16px 16px 0 0", padding: `${S.m2}px ${S.m2}px ${S.l}px`, transform: open ? "translateY(0)" : "translateY(100%)", transition: "transform 0.35s ease", zIndex: 101, overflowY: "auto", boxShadow: open ? "0 -8px 40px rgba(0,0,0,0.15)" : "none" }}>
        ...
        {postcode && travel.length > 0 && <div style={{ marginBottom: S.m2 }} />}

        <div style={{ borderTop: `1px solid ${COLORS.border}`, marginBottom: S.m2 }} />
        ...
        <div onClick={() => currentPay && onFilterLowPayChange && onFilterLowPayChange(!filterLowPay)} style={{ display: "flex", alignItems: "center", gap: S.s, cursor: currentPay ? "pointer" : "default", marginBottom: S.m2, opacity: currentPay ? 1 : 0.4 }}>
      ...
      <Section title={`Job description from ${job.company}`} noBorder>
        <div style={{ background: COLORS.card, borderRadius: 5, padding: `${S.m}px ${S.m}px ${S.xs}px` }}>
          <div style={{ ...T.body1, color: COLORS.muted, lineHeight: 1.7, fontFamily: FONT }}>
            {job.jd.map(({ label, text, bullets }, i) => (
              <div key={i} style={{ margin: `0 0 ${S.m}px` }}>
                <strong style={{ color: COLORS.text }}>{label}:</strong>
                {bullets ? (
                  <ul style={{ margin: `${S.xs}px 0 0`, paddingLeft: "1.4em" }}>
                    {bullets.map((b, j) => (
