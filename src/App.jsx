...
const HOURS_LABELS = new Set(["Short shift notice","Enough hours","No choice of shifts","No last-minute shift changes","Easy holiday booking","Holiday booking can be tricky","Shift changes can happen","Shift notice varies","Easy to book holiday","Easy to take sick leave","Sick leave isn't always easy","Some choice of shifts","Hours can exceed contract","Hours can match contract","Hours match contract"]);
...
const JOBS = [
  // ── 0: Main job — GXO Logistics ─────────────────────────────────────────────
  {
    ...
    rating: 6.7,
    quizCount: 918,
    highlights: ["No last-minute shift changes", "Enough hours"],
    ...
    jd: [
      { label: "", text: "At GXO, we know that when your supply chain works, everything works.\n\nWe're looking for Warehouse Operatives to join our team at our busy distribution centre in Corby, Northamptonshire. This is a permanent, full-time role working rotating shifts — 06:00–14:00 or 14:00–22:00 Monday to Friday. You'll be part of a large operation handling goods for some of the UK's biggest brands.\n\nPay & hours\n\nSalary: £25,958 per year\nShift premium: £945 per year\nTotal package: approximately £26,904 per year\nFull time — 37.5 hours per week\nRotating days, Monday to Friday\nOn-site parking available, Corby NN18 8EY\n\nWhat you'll be doing day to day:\n• Picking orders using RF scanner equipment\n• Loading and unloading — pump trucks and counterbalance equipment used on site\n• Put-away and stock location management\n• Cycle counts and stock accuracy checks\n- Reporting damaged goods or discrepancies\n- Keeping your work area clean and safe\n\nYou don't necessarily need previous experience — we provide full on-site training when you start. That said, if you've worked in a warehouse, distribution centre or manufacturing environment before, that's useful.\n\nWe're looking for people who:\n• Are reliable and can commit to a rotating shift pattern\n• Can work at pace in a target-driven environment\n• Are comfortable standing and walking for most of a shift\n• Can lift and move goods in line with manual handling guidance\n• Have the right to work in the UK" },
      { label: "", text: "What we offer\n\n28 days holiday per year including bank holidays (rises with service)\nWorkplace pension — employer contributions included\nGXO My Benefits platform — discounts, cashback, cycle to work and more\nAll PPE and uniform provided\nFree parking on site\nCareer progression — GXO promotes from within and this role can lead to Team Leader and beyond\n\nGXO is committed to equal opportunities and welcomes applications from all sections of the community. We value diversity and inclusion in everything we do. This role is subject to satisfactory references and, where applicable, a DBS check. You must have the right to work in the UK to be considered for this position." },
    ],
  },
  // ── 1: Amazon Warehouse Associate ───────────────────────────────────────────
  {
    ...
    jd: [
      { label: "", text: "At Amazon, we understand that work doesn't stop on the job.\n\nThat's why we have warehouse jobs that work for you.\n\nRole & Shifts\n\nPermanent role, day or night shift available, full time, part time. Shift availability may vary. Various shift patterns available including earlies, lates and nights — fixed shifts once agreed.\n\nPay\n\n£13.00 per hour\n£2.00 Night Shift Allowance on top for nights\n£19.50 Overtime rate (time and a half)\n\nYou'll also get paid breaks and a guaranteed number of contracted hours every week — no zero hours.\n\nLocation\n\nCOR1 — Amazon Fulfilment Centre, Corby, Northamptonshire, NN18. Free on-site parking. Not easily accessible by public transport — please check before applying.\n\nWhat you'll be doing with your team:\n\n• Receive, stow, pick, pack and sort — the full order cycle depending on your area\n• Scan and sort packages using handheld devices\n• Meet hourly rate targets (UPH) throughout your shift\n• Work safely and follow all standard operating procedures\n\nAfter training you may also:\n• Move products using powered equipment including pump trucks\n• Work across different zones and process paths\n\nYou don't need any previous experience. Amazon provides full paid training from your first day on site. You will need to be able to stand and walk for up to 10 hours per shift and lift items up to 23kg.\n\nBASIC QUALIFICATIONS\n\nNo formal qualifications required" },
      { label: "", text: "What you'll receive\n\n- Pay from £13.00/hr\n- Guaranteed contracted hours each week\n- Amazon pension with employer contributions\n- Employee discount on Amazon.co.uk\n- Occupational health support on site\n- Clear route to Process Assistant and Team Leader if you want to progress\n\nAmazon is an equal opportunities employer. We value diversity and are committed to inclusion. Your employment is conditional on satisfactory right to work documentation and references. Some roles may require a background check." },
    ],
  },
  // ── 2: DHL Supply Chain ──────────────────────────────────────────────────────
  {
    ...
    rating: 6.7,
    quizCount: 364,
    highlights: ["Enough hours", "No last-minute shift changes"],
    ...
    findings: {
      ...
      good: [
        { pct: 94, label: "Enough hours", subtext: "Based on 364 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "94% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week. A good job should guarantee you a minimum number of hours in a contract, if you want it." },
    ...
    jd: [
      { label: "", text: "DHL Supply Chain — Warehouse Operative — Northampton NN4\n\nPay: £12.75 per hour\nHours: Full time, Monday to Friday, day shifts\nLocation: Northampton, NN4 — please check travel before applying\n\nDHL Supply Chain is part of Deutsche Post DHL Group. We run warehousing and distribution operations for some of the UK's leading brands and we're looking for reliable people to join the team at our Northampton site.\n\nThis is a hands-on warehouse role. You'll be picking and packing orders, booking in deliveries, doing replenishment and generally keeping the operation running. It's busy and target-driven — you'll be expected to meet daily throughput KPIs.\n\nDay to day you could be:\n- Picking to RF scanner\n- Packing and labelling to client spec\n- Loading and unloading — manual handling throughout\n- Booking in inbound deliveries, checking and counting\n- Replenishment across all zones\n- Stock rotation and housekeeping\n\nWhat we need from you:\n\nPrevious warehouse experience is useful but not essential — we'll train you. You do need to be physically fit, able to stand and lift for most of your shift (up to 25kg), and reliable. Good attention to detail matters here. Right to work in the UK required.\n\nWhat we offer:\n£12.75/hr\n25 days holiday plus bank holidays (pro rata)\nPension with employer contributions\nDHL discount programme\nFree parking\nUniform and PPE included\nEmployee Assistance Programme" },
      { label: "", text: "DHL is a Top Employer UK certified business. We are committed to diversity and equal opportunities. Your offer of employment is subject to satisfactory references. Right to work checks will be carried out in line with UK employment law." },
    ],
  },
  // ── 3: Wincanton ─────────────────────────────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 95, label: "Enough hours", subtext: "Based on 659 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "95% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Wincanton — Kettering\n\nWincanton has been moving Britain's goods for over 90 years and we're growing. We're looking for Warehouse Operatives at our Kettering site to support a major retail client. Permanent, full-time roles with mixed shift patterns — days and afternoons.\n\nPay: £12.60 per hour\nHours: Full time\nShifts: Mixed days and afternoons — specific pattern confirmed at offer stage\nSite: Kettering, Northamptonshire, NN16\n\nWhat the job involves\n\nThis is a hands-on role in a busy distribution warehouse. On a typical shift you might be:\n• Picking orders against scan requirements\n• Booking in and checking inbound deliveries\n- Put-away to designated locations\n- Replenishment across multiple zones\n• Stock counts and inventory checks\n• General housekeeping — keeping the floor clean and safe\n\nYou'll be working to KPIs and daily throughput targets. The environment is fast-paced so you need to be comfortable with that.\n\nWhat we're looking for\n\nPrevious warehouse or logistics experience is preferred but if you're reliable, physically fit and have good attention to detail we'd encourage you to apply. You'll need to be able to stand for most of your shift and lift items up to 25kg. Right to work in the UK is essential." },
      { label: "", text: "Benefits include: £12.60/hr | 28 days holiday inc. bank holidays | Pension | Employee Assistance Programme | Free parking | Progression opportunities within the Wincanton network\n\nWincanton is an equal opportunities employer. We welcome applications from all backgrounds. Employment is subject to satisfactory references." },
    ],
  },
  // ── 4: XPO Logistics FLT Driver ──────────────────────────────────────────────
  {
    ...
    rating: 5.8,
    quizCount: 372,
    highlights: ["Enough hours", "No unpaid overtime"],
    ...
    findings: {
      ...
      good: [
        { pct: 86, label: "Enough hours", subtext: "Based on 372 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "86% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "FLT Driver — XPO Logistics — Northampton\n\nXPO is one of the largest logistics businesses in the world and we're currently hiring FLT Drivers at our Northampton site (NN4). Full time, Monday to Friday, day shifts.\n\nRate of pay: £14.25 per hour\nOvertime available at enhanced rates\nFree on-site parking\n\nAbout the role\n\nYou'll be operating counterbalance and reach trucks throughout the warehouse and loading bay — loading and unloading trailers, moving palletised stock into racking, doing pre-use checks, and supporting the goods-in team when it gets busy. You'll need to be comfortable hitting daily targets and working as part of a fast-moving team.\n\nDay to day:\n• Operating counterbalance FLT — loading and unloading HGVs\n• Operating reach truck — high racking putaway and retrieval\n• Pre-use vehicle checks and defect reporting\n• Stock movement recording via WMS\n- Supporting goods-in during peak inbound periods\n- General manual handling alongside FLT duties\n\nWhat you need:\n\nA valid counterbalance forklift licence is essential (RTITB or ITSSAR). Reach truck licence is desirable — if you only have counterbalance we may still consider you. You need at least 12 months of hands-on experience operating FLT in a warehouse or DC environment. Good H&S awareness, reliable attendance and right to work in the UK." },
      { label: "", text: "What's included: £14.25/hr | 25 days holiday + bank holidays | Pension | Uniform and PPE provided | Overtime at enhanced rates | Career development within XPO's network\n\nXPO is an equal opportunity employer. We are committed to creating an inclusive environment. Employment is subject to references and right to work verification." },
    ],
  },
  // ── 5: Amazon Warehouse Team Leader ──────────────────────────────────────────
  {
    ...
    jd: [
      { label: "", text: "Warehouse Team Leader (Process Guide) — Amazon — Corby\n\nAmazon is a company that thrives on innovation and the relentless pursuit of customer satisfaction. Our Corby Fulfilment Centre is one of the busiest in the UK network and we're looking for an experienced Team Leader — what we call a Process Guide internally — to lead a team of Associates on the warehouse floor.\n\nSalary: £34,320 per year\nThat's approximately £16.50 per hour\nFull time, fixed shifts — days, nights and weekends. Specific shift confirmed at offer stage.\nLocation: Corby Fulfilment Centre, NN18\n\nAbout the role\n\nThis is a working supervisory position. You'll be on the floor with your team the whole shift — monitoring performance, coaching people, making sure the right things are happening at the right time. You'll lead around 15–20 Associates and be the first point of call when issues come up.\n\nYou'll be responsible for:\n• Leading and motivating your team through the shift\n• Watching the real-time data and addressing any dips in performance\n• Coaching Associates on process, quality and safe working\n• Attendance tracking and timekeeping\n• End-of-shift reporting — throughput, quality, people\n- Supporting your Shift Manager with briefings and communications\n- Spotting improvement opportunities and sharing best practice\n\nWhat we need:\n\nYou'll need experience leading people in a warehouse, production or logistics environment — not necessarily Amazon, but you need to know what it means to run a team through a shift. Strong communication skills, comfortable reading WMS data, flexible on shift patterns, and a genuine commitment to safety. Right to work in the UK is essential." },
      { label: "", text: "What you get: £34,320/yr | No zero hours | Amazon pension | amazon.co.uk employee discount | Paid breaks | Free parking | Internal learning programmes | Clear pathway to Area Manager\n\nAmazon is an equal opportunities employer and is committed to a diverse and inclusive workplace. Employment is subject to satisfactory references and right to work documentation." },
    ],
  },
  // ── 6: Greencore Production Operative ────────────────────────────────────────
  {
    ...
    rating: 7.2,
    quizCount: 320,
    highlights: ["No last-minute shift changes", "Enough hours", "Proper breaks"],
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 89, label: "Enough hours", subtext: "Based on 320 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "89% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Production Operative — Greencore — Corby\n\nSalary: £25,958 per year (based on 37.5 hours per week)\nRotating shifts — days, afternoons and nights\nFull time\nCorby, Northamptonshire, NN17\n\nGreencore is one of the UK's biggest food manufacturers. You'll have eaten food we've made — we produce chilled, ready-to-eat meals, sandwiches and salads for major UK supermarkets. Our Corby site is a large chilled manufacturing facility and we're looking for Production Operatives to join the team on a permanent basis.\n\nThe environment is chilled — you'll be working at temperatures between 2°C and 8°C throughout your shift. It's a physical, fast-paced production line role where accuracy and food safety compliance are non-negotiable.\n\nWhat you'll be doing:\n\n• Working on the production line making chilled ready meals to spec\n• Operating production equipment following SOPs\n• Visual quality checks — making sure products are right before they leave your line\n• Allergen management and food hygiene procedures throughout\n- Line cleaning, changeovers and end-of-shift deep cleans\n- Completing production records accurately\n- Reporting machinery faults, quality issues or near-misses straight away\n\nYou don't need previous food manufacturing experience — full paid training is provided. A Level 2 Food Hygiene certificate is useful but not required. You do need to be physically fit, reliable, happy working in a chilled environment, and have the right to work in the UK." },
      { label: "", text: "Benefits: £25,958/yr | 33 days holiday inc. bank holidays | Pension | Free hot meals on site | Colleague discounts | PPE and uniform provided | Structured progression to Line Leader and above | Employee Assistance Programme\n\nGreencore is committed to the wellbeing of its people and proud to be an equal opportunities employer. We welcome applications from all backgrounds. Employment is subject to satisfactory references and right to work checks. Food safety and hygiene standards are strictly enforced on site." },
    ],
  },
  // ── 7: Royal Mail Parcel Sorter ───────────────────────────────────────────────
  {
    ...
    rating: 5.5,
    quizCount: 3650,
    highlights: ["Living wage", "Enough hours", "No unpaid overtime"],
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 82, label: "Enough hours", subtext: "Based on 3,650 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "82% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Parcel Sorter — Royal Mail — Wellingborough\n\nRoyal Mail has been delivering for over 500 years — and we need people who take that seriously. We're recruiting Parcel Sorters at our Wellingborough Delivery Office to help prepare mail and parcels for delivery rounds across local routes.\n\nPay & contract\n\nSalary: £25,958 per year\n(Based on full-time hours — approximately £13.15/hr)\nFull time\nEarly starts — shifts typically begin around 05:00\nWellingborough Delivery Office, Northamptonshire, NN8\n\nThis is a physical role. You'll be on your feet, lifting, sorting and moving mail throughout your shift. There are daily throughput targets. During peak periods (Christmas, bank holidays etc.) the volume goes up significantly.\n\nWhat you'll be doing:\n• Sorting letters, parcels and packets manually and using automated sorting equipment\n• Sequencing and organising mail by postcode and delivery round\n• Scanning items using barcode equipment\n- Loading and unloading delivery vans and cages in the loading bay\n- Unloading incoming mail bags and pallet deliveries\n• Keeping your area clean and safe\n• Reporting damaged items, security concerns or anything unusual\n\nNo previous experience needed. Royal Mail runs a full induction when you start. You do need to be punctual (early starts are non-negotiable), physically fit, able to lift up to 20kg regularly, and have the right to work in the UK." },
      { label: "", text: "What you get: £25,958/yr | Royal Mail pension | 25 days holiday + bank holidays | Sick pay (eligibility criteria apply) | Employee discount portal | Uniform and safety footwear | Free parking\n\nRoyal Mail is an equal opportunity employer. We celebrate diversity and are committed to creating an inclusive environment for all employees. Employment is conditional on satisfactory references, a right to work check, and in some cases a basic DBS disclosure." },
    ],
  },
  // ── 8: Evri Parcel Hub Operative ─────────────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 82, label: "Enough hours", subtext: "Based on 609 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "82% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Hub Operative — Evri — Corby\n\nEvri (previously Hermes) is one of the UK's largest parcel delivery networks. We're growing fast and we need people at our Corby hub to keep parcels moving.\n\nPay: £12.50 per hour\nPaid weekly\nFull time and part time available\nDays, nights and weekends — shift availability may vary\nCorby, Northamptonshire, NN18\nFree on-site parking\n\nAbout the role\n\nThis is a physical, hands-on job in a busy parcel hub. You'll be sorting and scanning parcels on conveyor belts, loading and unloading trailers, and hitting hourly throughput targets throughout your shift. It's not complicated work but it is relentless — you'll be on your feet and moving for the full shift.\n\nWhat you'll do:\n- Sort inbound and outbound parcels by destination zone on belt systems\n- Scan parcels with handheld devices throughout the process\n- Load and unload trailers in the yard\n- Flag damaged, undeliverable or mis-labelled parcels\n• General housekeeping and hub tidiness\n• Following health and safety procedures at all times\n\nYou need to be able to lift parcels up to 31.5kg regularly. No experience needed — we train you.\n\nPlease note: Contract types at this site vary and can include full-time, part-time and zero-hours arrangements. Please confirm the contract type before accepting." },
      { label: "", text: "What's included: £12.50/hr | Weekly pay | Flexible shifts | Evri parcel discount | Free parking\n\nEvri is an equal opportunities employer. Right to work in the UK required. Employment subject to satisfactory references." },
    ],
  },
  // ── 9: Clipper Logistics Pick & Pack ──────────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 73, label: "Enough hours", subtext: "Based on 107 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "73% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative (Fashion & Retail) — Clipper Logistics — Corby\n\nClipper Logistics works with some of the UK's best-known fashion and retail brands, handling fulfilment, returns and e-commerce. We're recruiting Warehouse Operatives at our Corby site (NN17) for a major retail brand client. Full time, Monday to Friday, day shifts.\n\nPay: £12.50 per hour\nHours: Full time\nShifts: Days, Monday–Friday\nLocation: Corby, Northamptonshire, NN17\n\nAbout this role\n\nThis is a pick and pack operation for a fashion or retail client. The work involves picking individual customer orders with care and packing them to very specific brand standards — presentation matters here, not just speed. You'll also handle returns and replenishment.\n\nTypical duties:\n• Picking individual orders from warehouse locations using RF scanner\n• Packing to brand standards — correct packaging, inserts, folding\n• Labelling and checking order documentation before dispatch\n• Hitting and maintaining hourly pick rate targets\n- Replenishment of pick face locations\n- Processing returns and exchanges per client procedure\n- Reporting damaged stock or pick errors promptly\n\nYou don't need experience — we train you. Attention to detail is important because errors affect the customer. You need to be physically fit (on your feet all shift), reliable, and have the right to work in the UK." },
      { label: "", text: "What's included: £12.50/hr | 28 days holiday inc. bank holidays | Pension | Staff discount | Overtime at enhanced rates | Free parking | Uniform provided\n\nClipper Logistics is part of GXO Logistics. We are committed to equal opportunities in recruitment and employment. Employment is subject to satisfactory references and right to work verification." },
    ],
  },
  // ── 10: PepsiCo — Warehouse Operative ────────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 88, label: "Enough hours", subtext: "Based on 412 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "88% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — PepsiCo — Leicester\n\nPepsiCo makes some of the UK's best-loved food and drink brands — Walkers, Pepsi, Quaker, Doritos, Tropicana and more. We're looking for Warehouse Operatives to join our distribution operation in Leicester on a permanent, full-time basis.\n\nSalary: £34,727 per year\nRotating shifts — specific pattern confirmed at offer stage\nLeicester\n\nThis is a large, high-volume warehouse environment. You'll be picking case and pallet orders, loading and unloading vehicles, doing putaway, and helping with stock checks. Food safety and hygiene standards apply throughout the site.\n\nDay to day duties:\n\n• Picking orders using voice pick or RF scanner\n• Wrapping and stacking outbound pallets\n• Loading and unloading delivery vehicles\n• Receiving and putting away inbound stock\n• Stock checks and periodic inventory counts\n- Operating electric pallet trucks\n- Following PepsiCo food safety and hygiene requirements throughout\n- Hitting daily pick rate and accuracy targets\n\nWhat we need from you\n\nPrevious warehouse experience preferred. You need to be physically fit, reliable, able to work rotating shifts including early mornings and late evenings, and have the right to work in the UK." },
      { label: "", text: "Benefits: £34,727/yr | Pension with generous employer contributions | Annual bonus (subject to performance) | PepsiCo staff product discount | Private medical insurance (criteria apply) | Life assurance | Free parking | Subsidised canteen\n\nPepsiCo is an equal opportunity employer. We value diversity and inclusion and welcome applications from all backgrounds. Employment is subject to satisfactory references and right to work verification." },
    ],
  },
  // ── 11: The Best Connection — Warehouse Operative ────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 84, label: "Enough hours", subtext: "Based on 27 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "84% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — The Best Connection Employment Group — Corby\n\nPay rate: £11.44 per hour\nWeekly pay\nFull time, day shifts\nCorby, NN17 area\nImmediate starts available\n\nThe Best Connection is a national industrial recruitment agency. We're placing Warehouse Operatives at client sites in and around Corby. The specific site will depend on availability — duties are broadly similar across locations and cover the full range of general warehouse work.\n\nTypically this means:\n- Picking and packing orders\n- Receiving and checking inbound deliveries\n- Put-away\n- Loading and unloading — manual handling throughout\n- Scanner operation and basic documentation\n- Replenishment and stock support\n- General housekeeping\n\nNote: you may be placed at different sites on different weeks depending on demand. This is agency work — you will be employed by The Best Connection, not the end client.\n\nNo warehouse experience needed. You need to be physically fit, reliable, available full time and have the right to work in the UK. You will need to bring two forms of ID when you register." },
      { label: "", text: "What you get: £11.44/hr | Weekly pay | Holiday pay accrued on all hours worked | Best Connection benefits portal | Potential route to permanent employment at client sites\n\nThe Best Connection Group Ltd. is an equal opportunities employer. All placements are subject to registration, right to work checks and satisfactory references." },
    ],
  },
  // ── 12: Group Nexus — Warehouse Operative (Northampton) ───────────────────────
  {
    ...
    rating: 5.5,
    quizCount: 68,
    highlights: ["Enough hours", "Proper breaks"],
    listingUrl: "https://www.breakroom.cc/en-gb/jobs",
    altBadge: null,
    altReason: null,
    payBenchmark: { rangeLow: 12, rangeHigh: 14, roleLabel: "warehouse operatives in Northamptonshire" },
    ...
    findings: {
      ...
      good: [
        { pct: 82, label: "Enough hours", subtext: "Based on 68 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "82% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Group Nexus — Northampton\n\nGroup Nexus are recruiting Warehouse Operatives for client sites in Northampton. Days, lates and nights available — shifts and sites vary.\n\nPay rates:\n£11.44/hr days\n£13.75/hr lates\n£14.50/hr nights\nWeekly pay\nHoliday pay accrued on all hours worked\n\nThis is agency work — you will be employed by Group Nexus and placed with our client(s). The site and duties may change. Typical warehouse duties include:\n\n- Goods-in: unloading vehicles, checking deliveries, booking in\n- Picking — paper, scanner or voice pick depending on the site\n- Packing and labelling\n- Loading outbound consignments\n- Stock checks\n- Housekeeping\n- Any other reasonable warehouse duties as directed\n\nNo previous experience required. You need to be physically fit, available for rotating shifts, reliable, and have the right to work in the UK. You will need to bring ID documents to register." },
      { label: "", text: "Group Nexus are an equal opportunities employer. Placements are subject to registration, right to work verification and satisfactory references. Temp-to-perm may be available at some sites for the right candidates." },
    ],
  },
  // ── 13: Group Nexus — Warehouse Operative (Wellingborough) ───────────────────
  {
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Group Nexus — Wellingborough\n\nGroup Nexus are currently placing Warehouse Operatives at client sites in and around Wellingborough. This is agency work — hours and site may vary. Shifts available across days, lates and nights.\n\nPay:\n£11.44/hr days\n£13.75/hr lates\n£14.50/hr nights\nWeekly pay — holiday pay accrued\n\nDuties vary by site but typically include:\n\n- Goods-in — unloading, checking and booking in deliveries\n- Picking via paper, scanner or voice pick\n- Packing and labelling outbound orders\n- Loading vehicles and managing consignment docs\n- Cycle counts and stock checks\n- Housekeeping and maintaining a safe work area\n- Any other reasonable warehouse tasks as directed\n\nYou don't need previous experience. You need to be physically fit, available for rotating shifts (including nights), reliable and hold the right to work in the UK. Please bring ID to your registration appointment." },
      { label: "", text: "Group Nexus is an equal opportunities employer. This is a temporary placement role. Temp-to-perm may be available. Placements are subject to registration and right to work checks." },
    ],
  },
  // ── 14: Yusen Logistics — Warehouse Operative ─────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 87, label: "Enough hours", subtext: "Based on 183 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "87% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Yusen Logistics — Courteenhall, NN7\n\nYusen Logistics is part of the NYK Group, a global leader in international shipping and logistics. We have an opening for a Warehouse Operative at our site in Courteenhall, Northamptonshire (NN7). This is a permanent, full-time, day shift role.\n\nSalary: £27,081 per year\n(approximately £13.02 per hour)\nFull time\nDay shifts\nCourteenhall, Northamptonshire, NN7\nFree parking on site\nPlease note: the site is rural and not well served by public transport. You will likely need your own transport.\n\nAbout the role\n\nThis is a general warehouse operative position supporting a client account. You'll be working within a stable, established team doing the full range of warehouse tasks — inbound, picking, packing, putaway, despatch. Not a high-volume parcel operation — more methodical, accuracy-focused work.\n\nWhat you'll be doing:\n• Receiving inbound deliveries — checking, counting, documentation\n• Putaway to correct WMS locations\n• Picking customer orders with RF scanner\n• Packing, wrapping and labelling for despatch\n- Stock checks and inventory counts\n- Pallet truck and pump truck operation\n- Keeping the warehouse clean and organised\n- Reporting discrepancies, damage or H&S concerns\n\nPrevious warehouse experience is preferred. Attention to detail and reliable attendance are important. Right to work in the UK required." },
      { label: "", text: "Package: £27,081/yr | Pension | Statutory holiday entitlement | Free parking | Stable day shift pattern | Development opportunities within a global logistics group\n\nYusen Logistics is committed to equal opportunities. Employment is subject to satisfactory references and right to work checks." },
    ],
  },
  // ── 15: Rhenus Group — Warehouse Supervisor ───────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 85, label: "Enough hours", subtext: "Based on 89 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "85% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Supervisor — Rhenus Group — Corby NN17\n\nRhenus Group is an international logistics provider with over 1,000 locations across the globe. We're recruiting a Warehouse Supervisor for our Corby site to take charge of a shift team and keep the operation running to plan.\n\nSalary: £28,000 per year\nFull time\nRotating shifts — earlies, lates and occasional weekends\nCorby, Northamptonshire, NN17\n\nThis is a working supervisory role — you'll be on the floor with your team, not in an office. You'll be allocating tasks, managing throughput, dealing with attendance, doing briefings and making sure all the H&S boxes are being ticked. You'll also need to do end-of-shift reporting and contribute to CI work on site.\n\nResponsibilities:\n• Supervising a team of Warehouse Operatives — allocating tasks, managing workload\n• Monitoring KPIs for throughput, accuracy and quality — taking action when things drift\n• Running shift briefings, communicating process changes and safety info\n• Overseeing inbound and outbound operations\n- Managing attendance and absence — escalating to Ops Manager when needed\n- Inducting and training new starters\n- End-of-shift reporting\n- Continuous improvement contributions\n\nWhat we need:\n\nPrevious supervisory or team leader experience in a warehouse is essential. Strong communication skills, good with WMS and Microsoft Office, solid H&S knowledge, and flexibility on shift patterns. Right to work in the UK." },
      { label: "", text: "Package: £28,000/yr | 28 days holiday inc. bank holidays | Pension with employer contributions | Free parking | Uniform and PPE provided | Progression opportunities within Rhenus Group UK and European network\n\nRhenus is committed to equality and diversity. Employment is subject to satisfactory references and right to work verification." },
    ],
  },
  // ── 16: Rhenus Group — Warehouse Manager ─────────────────────────────────────
  {
    ...
    jd: [
      { label: "", text: "Warehouse Manager — Rhenus Group — Corby\n\nRhenus Group is an international contract logistics business with operations across more than 1,000 locations globally. We're looking for a Warehouse Manager to take full operational responsibility for our Corby site (NN17).\n\nSalary: £38,000 per year\nFull time, days\n+ car allowance or company car (subject to discussion)\nCorby, Northamptonshire, NN17\n\nThis is a senior site leadership role. You'll own the operation end to end — people, performance, cost, compliance and the client relationship. You'll manage a team of supervisors and operatives, drive KPI performance, control the labour budget and be the primary operational face for the client on site.\n\nKey responsibilities:\n\n• Full operational accountability across all shifts and warehouse functions\n• Managing, developing and performance managing supervisors and operatives\n• Driving performance against contractual KPIs: throughput, accuracy, H&S, cost\n• Operational improvement planning in partnership with the client account team\n• Budget management — cost control and labour resource planning\n• Full H&S and legal compliance across the site\n• Primary operational point of contact for the client\n- Regular performance reporting and MI for senior stakeholders\n- Recruitment, onboarding and people development with HR support\n\nWhat we need:\n\nProven warehouse or DC management experience is essential. Contract logistics experience preferred. Strong people leadership, hands-on WMS proficiency, commercial awareness, excellent communication, solid H&S knowledge. Right to work in the UK." },
      { label: "", text: "Package: £38,000/yr | Car allowance or company car (subject to role) | 25 days holiday + bank holidays | Pension | Free parking | Progression within Rhenus Group's growing UK and European network\n\nRhenus Group is committed to equal opportunities and diversity. Employment is subject to satisfactory references and right to work checks." },
    ],
  },
  // ── 17: Reed — Warehouse Operative ───────────────────────────────────────────
  {
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Reed — Northampton\n\nReed are recruiting Warehouse Operatives for temporary placements with client sites in and around Northampton. Day shifts, full time. Consistent hours with potential for overtime and temp-to-perm.\n\nPay: £11.44 per hour\nWeekly pay\nHoliday pay accrued\nNorthampton area\n\nThis is agency work through Reed. You'll be placed at client warehouse sites — the site and specific duties can vary. General warehouse work throughout — picking, packing, goods-in, loading. You may be asked to work at different sites within the Northampton area.\n\nTypical duties:\n- Picking orders using paper or RF scanner\n- Packing and labelling to client standards\n- Processing goods-in and completing inbound documentation\n- Loading and unloading — manual handling throughout\n- Stock checks and cycle count support\n- Housekeeping\n- Any other reasonable duties as directed\n\nNo previous experience required. You need to be physically fit and reliable. You will need two forms of ID when you register. Right to work in the UK essential." },
      { label: "", text: "What you get: £11.44/hr | Weekly pay | Holiday pay accrued | Reed Benefits Hub — online discounts and wellbeing resources | Temp-to-perm opportunities | Support from dedicated Reed consultant\n\nReed is an equal opportunities employer and positively encourages applications from suitably qualified and eligible candidates regardless of sex, race, disability, age, sexual orientation, gender reassignment, religion or belief, marital status, or pregnancy and maternity." },
    ],
  },
  // ── 18: Millbrook Healthcare — Warehouse Operative ────────────────────────────
  {
    ...
    rating: 6.8,
    quizCount: 93,
    highlights: ["Enough hours", "Living wage", "No last-minute shift changes"],
    listingUrl: "https://www.breakroom.cc/en-gb/jobs",
    altBadge: null,
    altReason: null,
    payBenchmark: { rangeLow: 12, rangeHigh: 14, roleLabel: "warehouse operatives in Northamptonshire" },
    ...
    findings: {
      ...
      good: [
        { pct: 88, label: "Enough hours", subtext: "Based on 93 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "88% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operative — Millbrook Healthcare — Northampton NN1\n\nMillbrook Healthcare provides community equipment and complex rehabilitation solutions to NHS Integrated Care Boards and local authorities across England. We supply wheelchairs, hoists, pressure care equipment and other medical items directly to patients and healthcare settings. We're looking for a Warehouse Operative to join our Northampton depot.\n\nSalary: £25,400 per year\nFull time\nDay shifts\nNorthampton, NN1\nFree parking on site\n\nThis is warehouse work but the context matters — the equipment you pick and prepare goes to real patients. Accuracy in this role has a direct impact on patient care. You'll be handling medical equipment including items that are large and heavy. Some returned equipment will need inspection, cleaning and decontamination before it can go back out.\n\nDay to day:\n• Picking and packing medical equipment orders against pick lists and electronic requests\n• Preparing equipment for delivery to patients and NHS facilities\n• Receiving and booking in returned equipment — condition checks, cleaning\n• Loading and unloading delivery vehicles\n• Stock records maintenance in the depot system\n- Cleaning and decontamination of returned equipment to infection control standards\n- Stock checks and inventory audits\n- Keeping the depot clean and organised\n\nPrevious warehouse or stores experience is useful but not essential. A conscientious, reliable approach matters more here than in a typical warehouse. You need to be physically fit (some larger, heavier items), comfortable working in a healthcare environment, and have the right to work in the UK." },
      { label: "", text: "Package: £25,400/yr | 28 days holiday inc. bank holidays | Pension | Free parking | Uniform provided\n\nMillbrook Healthcare is an equal opportunities employer. This role may be subject to a DBS check due to the vulnerable adults/healthcare setting. Employment is conditional on satisfactory references and right to work verification." },
    ],
  },
  // ── 19: Samworth Brothers — Warehouse Operations Manager ─────────────────────
  {
    ...
    rating: 7.0,
    quizCount: 54,
    highlights: ["No last-minute shift changes", "Enough hours", "Living wage"],
    listingUrl: "https://www.breakroom.cc/en-gb/jobs",
    altBadge: "Better rated",
    altReason: null,
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 88, label: "Enough hours", subtext: "Based on 54 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "88% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
    ...
    jd: [
      { label: "", text: "Warehouse Operations Manager — Samworth Brothers — Leicester\n\nSamworth Brothers is a family-owned British food business founded in 1896. You'll know our brands: Ginsters, Soreen, West Cornwall Pasty Co., Bradgate Bakery. We produce premium chilled food for major UK retailers from multiple manufacturing sites, including our Leicester facility.\n\nWe're looking for a Warehouse Operations Manager to take strategic and day-to-day operational responsibility for our warehousing function in Leicester. This reports into the Head of Operations.\n\nSalary: £55,000 per year\nFull time, days (some flexibility required for a multi-shift operation)\nLeicester\n\nScope of the role\n\nThis is a senior management position overseeing a multi-shift warehouse team — supervisors and operatives. You're accountable for performance across intake, storage, picking and despatch. Retail customer service standards are exacting — the quality and accuracy expectations are high. This is a BRC/BRCGS-audited site.\n\nKey responsibilities:\n• Strategic and operational leadership across all warehouse functions\n• Managing and developing shift supervisors and warehouse operatives\n• Full ownership of warehouse KPIs — throughput, accuracy, waste, cost, H&S\n• Continuous improvement and lean project leadership\n• WMS management — data integrity across inventory and stock records\n• Recruitment, onboarding and performance management with HR\n- Cross-functional stakeholder management: production, logistics, planning\n- Full compliance: BRC/BRCGS, HACCP, H&S and environmental legislation\n- Operational strategy contribution and performance reporting to senior leadership\n\nWhat we need:\n\nProven senior warehouse management experience, ideally in food, FMCG or chilled. Strong people leadership (large multi-shift operation). WMS experience including data analysis. Sound food safety knowledge (BRC/BRCGS, HACCP). Commercially minded. Excellent stakeholder management. CI mindset. Right to work in the UK." },
      { label: "", text: "Package: £55,000/yr | Pension with employer contributions | 25 days holiday + bank holidays | Samworth Brothers staff product discount | Employee Assistance Programme | Free parking\n\nSamworth Brothers is an equal opportunities employer. We value diversity and are committed to creating an inclusive workplace. Employment is conditional on satisfactory references, right to work checks, and in some cases, a Disclosure and Barring Service check." },
    ],
  },
  // ── 20: Movianto — Warehouse Operative ───────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 85, label: "Enough hours", subtext: "Based on 148 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "85% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 21: Gi Group — Warehouse Operative ───────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 76, label: "Enough hours", subtext: "Based on 74 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "76% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 22: Newcold — QC & Warehouse Inventory Associate ──────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 89, label: "Enough hours", subtext: "Based on 127 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "89% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 24: Great Bear Distribution — Warehouse Administrator ────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 86, label: "Enough hours", subtext: "Based on 187 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "86% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 25: Lidl — Warehouse Maintenance Operative ────────────────────────────────
  {
    ...
    rating: 7.2,
    quizCount: 1243,
    highlights: ["Living wage", "Enough hours", "No last-minute shift changes"],
    listingUrl: "https://www.breakroom.cc/en-gb/jobs",
    altBadge: "Better rated",
    altReason: null,
    ...
    findings: {
      ...
      good: [
        ...
        { pct: 90, label: "Enough hours", subtext: "Based on 1,243 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "90% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 26: Culina — Warehouse Administrator ─────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 84, label: "Enough hours", subtext: "Based on 312 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "84% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 27: DHL — Warehouse Trainer ───────────────────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 94, label: "Enough hours", subtext: "Based on 365 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "94% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 28: Berry Recruitment — Warehouse Operative ───────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 78, label: "Enough hours", subtext: "Based on 48 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "78% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  // ── 29: GSF Car Parts — Warehouse Operative ──────────────────────────────────
  {
    ...
    findings: {
      ...
      good: [
        { pct: 80, label: "Enough hours", subtext: "Based on 96 Breakroom Quiz responses", heading: "Most people don't worry about their hours", primary: "Most people don't worry about their hours.", secondary: "80% of people report they don't worry about getting enough hours.", why: "At a good job, you shouldn't have to worry about getting enough hours each week." },
  ...
  return (
    <div>
      ...
      <div style={{ maxWidth: 1032, margin: "0 auto", padding: `${S.m}px ${S.m}px ${S.xxl}px` }}>
        <p style={{ ...T.body2, fontSize: 18, fontWeight: 700, color: COLORS.text, fontFamily: FONT, margin: `24px 0 ${S.s}px` }}>
...
<div style={{ background: COLORS.card, borderRadius: 5, boxShadow: "0px 4px 4px rgba(0,0,0,0.05)", padding: `${S.m}px ${S.m2}px` }}>
  ...
  const sectionsBlock = (
    <>
      ...
      <Section key={`jd-${job.id}`} title={`Job description from ${job.company}`} noBorder>
          ...
          <div style={{ ...T.body1, color: COLORS.muted, lineHeight: 1.7, fontFamily: FONT }}>
            {job.jd.map(({ label, text, bullets }, i) => (
              <div key={i} style={{ margin: `0 0 ${S.m}px` }}>
                {label ? <strong style={{ color: COLORS.text }}>{label}: </strong> : null}
                {bullets ? (
                  <ul style={{ margin: label ? `${S.xs}px 0 0` : `0 0 0`, paddingLeft: "1.4em" }}>
                    {bullets.map((b, j) => (
